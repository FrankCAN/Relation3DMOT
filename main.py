...
parser.add_argument('--config', default='experiments/rrc_pfv_40e_subabs_dualadd_C/config.yaml') # pp_pv_40e_mul_C
...
def train(train_loader, val_loader, trainval_loader, tracking_module,
    ...
    for i, (input, det_info, det_id, det_cls,
        ...
        if (curr_step + 1) // config.val_freq == 5:
            print('break at iter 10')
            break
