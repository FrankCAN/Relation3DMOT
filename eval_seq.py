...
parser.add_argument('--config', default='experiments/rrc_pfv_40e_subabs_dualadd_C/config.yaml')
parser.add_argument('--load-path', default='experiments/rrc_pfv_40e_subabs_dualadd_C/ckpt_best.pth.tar', type=str)
...
def main():
    ...
    args.result_path = f"{args.result_path}/{datetime_str}"
